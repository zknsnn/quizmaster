...
//                question = new Question(questionId, questionText, correctAnswer, wrongAnswer1, wrongAnswer2, wrongAnswer3, quizDAO.getOneById(quizname));
    ...
    public Question getOneById(int id) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                String wrongAnswer3 = resultSet.getString("wrongAnswer3");
                String quizname = resultSet.getString("quizName");
//                question = new Question(questionId, questionText, correctAnswer, wrongAnswer1, wrongAnswer2, wrongAnswer3, quizDAO.getOneByName(quizname));
            }
        } catch (SQLException sqlError) {
            System.out.println("SQL error " + sqlError.getMessage());
        }
